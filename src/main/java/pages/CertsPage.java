...
public class CertsPage extends PageObject {
    ...
    public void inputFileName(){
        //WebElement element = getDriver().findElement(By.id("'fileUploadField'"));
        //element.sendKeys("C:\\Users\\Вероника\\Downloads\\certnew.cer");
        //web drv = (ChromeDriver)getDriver();
        //getDriver().getKeyboard().sendKeys("C:\\Users\\Вероника\\Downloads\\certnew.cer");

        //.actions().sendKeys("Test").perform();

//        SendKeys("C:\\Users\\Вероника\\Downloads\\certnew.cer");
//        SendKeys("{ENTER}");
    }
}
